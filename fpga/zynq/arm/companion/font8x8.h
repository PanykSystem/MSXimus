/* font8x8.h — GENERADO por zynq/tools/make_oled_font.py desde src/iosys/font.vh.
 * NO EDITAR A MANO. Fuente 8x8 del OSD, traspuesta a columnas para el SSD1306:
 * cada byte = una columna de 8 pixeles verticales (bit0 = arriba).
 * Caracteres 0x20..0x7F; FONT8X8[c - 0x20][columna]. */
#ifndef FONT8X8_H_
#define FONT8X8_H_
...
static const unsigned char FONT8X8[FONT8X8_COUNT][8] = {
